...
import { useIterationSourceConfig } from './useIterationSourceConfig';
import IterationSourceFields from './IterationSourceFields';

const numInput = { ...S.select, width: 80, display: 'inline-block' };

export default function TriKanbanCycleTimeGadgetEdit() {
  const cfg = useIterationSourceConfig();
  ...
  return (
    <div style={S.wrap}>
      ...
      <IterationSourceFields {...cfg} />

      <div style={S.divider} />

      <Section title="5. Hours per Story Point">
      ...
      <Section title="6. Business Hours">
